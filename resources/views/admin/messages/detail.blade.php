...
@section('content')
    <div class="tabs-wrapper">
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#reports" href="#/reports">Message Details</a></li>
        </ul>
    </div>
                            ...
                            <table id="message-detail-table" class="table dt-responsive nowrap dataTable no-footer collapsed">
                                ...
                                @foreach($messages as $message)
                                    <tr>
                                        ...
                                        <td>
                                            <div><img src="{{asset('assets/img/flags/'.strtolower($message->recipient->country).'.png')}}" class="mr-1"> {{$message->recipient->phone_number}}</div>
                                        </td>

<tr>
    ...
    <td>
        <div class="w-100 d-flex justify-content-around align-items-center">
            <a href="{{route('admin.recipient.email',['recipientId'=>$recipient->id])}}" class="btn btn-sm btn-edit view-item mr-1 {{$recipient->emailCount()==0?'disabled':''}}" data-id="{{$recipient->id}}">
                <div><i class="fa fa-eye"></i>Emails({{$recipient->emailCount()}})</div>
            </a>
